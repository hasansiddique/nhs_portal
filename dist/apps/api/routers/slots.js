...
exports.slotsRouter = (0, trpc_1.router)({
    available: trpc_1.publicProcedure
        ...
        const slots = yield ctx.prisma.slot.findMany({
            where: Object.assign(Object.assign(Object.assign({}, (input.practitionerId && { practitionerId: input.practitionerId })), (input.locationId && { locationId: input.locationId })), { 
                // Overlap with [from, to) so same-calendar-day queries work even if `to` is midnight next day.
                startAt: { lt: input.to }, endAt: { gt: input.from }, appointment: null }),
            include: {
